      ...
      <v-row>
        <v-col cols="12">
          <v-card class="mx-auto rounded-xl" flat>
            <v-img src="cover2.webp" max-height="100%" max-width="100%" contain>
              <v-card-title class="top ml-10">
                <h2 class="title1">Pide tus</h2>
              </v-card-title>
              <v-card-title class="ml-10 mt-n8">
                <h2 class="title2">Platos preferidos</h2>
              </v-card-title>
              <v-card-text class="ml-10">
                <h3 class="green--text">#Domicilios gratis</h3>
              </v-card-text>
              <v-card-text class="ml-10">
                <v-row>
                  <v-col cols="4">
          ...
          <v-toolbar flat color="transparent">
            <v-toolbar-title class="text-h6">Categorias</v-toolbar-title>
            <v-spacer></v-spacer>
          ...
          <v-card flat color="#E2F2E5" class="rounded-xl mt-8">
            <v-toolbar flat color="transparent" class="mb-4">
              <v-toolbar-title class="text-h6 mt-5"
                >Platos mejor calificados</v-toolbar-title
              >
              <v-spacer></v-spacer>
            </v-toolbar>
            <Pack />
          ...
          <v-toolbar flat color="transparent" class="mt-8">
            <v-toolbar-title class="text-h6"
              >Nuestros patroncinadores</v-toolbar-title
            >
          </v-toolbar>
          <Partner />
          <v-card
          ...
          >
            <v-row>
              ...
              <v-col cols="12" xs="12" sm="6" md="7">
                ...
                <p>
                  Comentarios de la aplicacion o nombre.<br />
                  Descripcion de nuetsra aplicacion.<br />
                  Incentivos de descarga,<br />
                  Eslogan!
                </p>
